...
public interface ComponentDescriptor<B> extends Comparable<ComponentDescriptor<?>>, Serializable, HasAliases {
     ...
     */
    boolean isMultiStreamComponent();
     ...
     */
    Set<ConfiguredPropertyDescriptor> getConfiguredPropertiesByAnnotation(Class<? extends Annotation> annotation);
     ...
     */
    Set<ConfiguredPropertyDescriptor> getConfiguredPropertiesByType(Class<?> type, boolean includeArrays);
     ...
     */
    ConfiguredPropertyDescriptor getConfiguredProperty(String name);
