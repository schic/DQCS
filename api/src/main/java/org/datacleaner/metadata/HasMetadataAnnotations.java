...
public interface HasMetadataAnnotations {
     ...
     *         was found.
     */
    MetadataAnnotation getAnnotation(String annotationName);
     ...
     *         adapt was found
     */
    <M> M getAdaptedAnnotation(MetadataAnnotationAdaptor<M> annotationAdaptor);
     ...
     * @return
     */
    List<MetadataAnnotation> getAnnotations();
}
