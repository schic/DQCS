...
public final class PrefixedIdGenerator implements IdGenerator {
    ...
    public PrefixedIdGenerator(final String prefix) {
        this(prefix, 4);
    }

    public PrefixedIdGenerator(final String prefix, final int idNumberSize) {
        if (idNumberSize <= 0) {
    ...
    public String nextId() {
        ...
        final DecimalFormat format = new DecimalFormat(idNumberPattern);
