...
public abstract class AbstractPropertyDescriptor implements PropertyDescriptor {
    ...
    public AbstractPropertyDescriptor(final Field field, final ComponentDescriptor<?> componentDescriptor) {
        if (field == null) {
    ...
    @Override
    public Object getValue(final Object bean) throws IllegalArgumentException {
        if (bean == null) {
    ...
    public boolean equals(final Object obj) {
        ...
        final AbstractPropertyDescriptor other = (AbstractPropertyDescriptor) obj;
        if (_name == null) {
            if (other._name != null) {
                return false;
            }
