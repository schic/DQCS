...
public class DateDiffTransformer implements Transformer {
    ...
    public Number[] transform(final InputRow inputRow) {
        final Date from = inputRow.getValue(fromColumn);
        final Date to = inputRow.getValue(toColumn);
    ...
    public Number[] transform(final Date from, final Date to) {
        ...
        final Number[] result = new Number[numbers.size()];
    ...
    public void setSeconds(final boolean seconds) {
        this.seconds = seconds;
    }

    public void setMilliseconds(final boolean milliseconds) {
