...
/**
 * <p>abstractDatastoreType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="abstractDatastoreType"&gt;
 *   &lt;complexContent&gt;
...
@XmlSeeAlso({
    ...
    SalesforceDatastoreType.class,
    SugarCrmDatastoreType.class,
    DatahubDatastoreType.class,
    Neo4JDatastoreType.class,
    PojoDatastoreType.class,
    HbaseDatastoreType.class,
    MongodbDatastoreType.class,
    ElasticSearchDatastoreType.class,
    CassandraDatastoreType.class,
    CouchdbDatastoreType.class,
    FixedWidthDatastoreType.class,
    SasDatastoreType.class,
    ExcelDatastoreType.class,
    JsonDatastoreType.class,
