...
/**
 * <p>cassandraDatastoreType complex type的 Java 类。
 * 
...
@XmlType(name = "cassandraDatastoreType", propOrder = {
    "keyspace",
    "hostname",
    "port",
    "username",
...
public class CassandraDatastoreType
    extends AbstractDatastoreType
{
    ...
    protected List<CassandraDatastoreType.TableDef> tableDef;
     ...
     * {@link CassandraDatastoreType.TableDef }
     * 
     * 
     */
    public List<CassandraDatastoreType.TableDef> getTableDef() {
        if (tableDef == null) {
            tableDef = new ArrayList<CassandraDatastoreType.TableDef>();
        }
    ...
    public static class TableDef {
        ...
        @XmlElement(required = true)
        protected List<CassandraDatastoreType.TableDef.Column> column;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CassandraDatastoreType.TableDef.Column }
         * 
         * 
         */
        public List<CassandraDatastoreType.TableDef.Column> getColumn() {
            if (column == null) {
                column = new ArrayList<CassandraDatastoreType.TableDef.Column>();
            }
            return this.column;
        }
